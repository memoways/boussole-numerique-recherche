...
const PERSONAS: Persona[] = [
  {
    ...
    faq: [
      { question: "Pourquoi mobiliser notre structure maintenant ?", answer: "Parce que les difficultés numériques des artistes ne remontent pas toujours jusqu’aux personnes qui choisissent les outils, les procédures ou les accompagnements. Les recueillir maintenant permet de partir de situations vécues, de ne pas attendre qu’une solution soit arrêtée et de préparer des améliorations qui répondent réellement aux pratiques du terrain." },
      { question: "Qu’est-ce que la future Boussole doit proposer ?", answer: "La Boussole devra être une application web qui aide à décrire une situation, à repérer des priorités et à choisir une première amélioration praticable. Elle doit ouvrir une discussion sur les outils, compétences, données, diffusion et collaborations. Elle ne doit ni noter les personnes, ni classer les organisations, ni prescrire une solution unique.", link: { label: "Voir les dimensions illustratives du futur outil", href: "/experience" } },
      { question: "Où en est le projet aujourd’hui, concrètement ?", answer: "La Boussole n’existe pas encore. Aujourd’hui, le site compagnon informe et recueille des retours. Entre septembre et octobre 2026, l’atelier et le cadrage doivent préciser les premiers cas d’usage. Un prototype à tester est visé pour la fin 2026 ; une ouverture publique est visée au début 2027.", link: { label: "Voir le calendrier indicatif", href: "/timeline" } },
      { question: "Comment notre contribution influencera-t-elle le prototype ?", answer: "Le questionnaire, les situations signalées et l’atelier serviront à choisir les questions à poser, les aides à proposer et les critères d’un test utile. Les partenaires ne valident pas un outil fini : ils contribuent, avec les artistes, à décider ce qui mérite d’être construit, testé puis amélioré de façon concertée.", link: { label: "Comprendre les principes de co-conception", href: "/methode" } },
      { question: "Quels bénéfices pour notre structure et les artistes que nous accompagnons ?", answer: "La démarche doit donner un repère commun pour rendre les besoins plus faciles à formuler, préparer des changements réalistes et relier les retours des artistes aux décisions des structures. Le bénéfice attendu n’est pas un tableau de classement : c’est une capacité accrue à choisir ensemble des outils, procédures ou appuis plus adaptés." },
    ],
  ...
  },
  {
    ...
    faq: [
      { question: "Pourquoi améliorer les pratiques numériques maintenant ?", answer: "Parce que des fichiers introuvables, des outils qui ne s’accordent pas ou des consignes difficiles à partager peuvent alourdir le travail et les collaborations. Il ne s’agit pas de vous demander d’en faire plus ni de devenir spécialiste : l’enjeu est de mieux choisir ce qui peut rendre votre environnement numérique plus lisible, plus serein et plus soutenant." },
      { question: "Qu’est-ce que la future Boussole doit faire pour moi ?", answer: "La Boussole devra être une application web qui vous aide à mettre des mots sur une situation, à repérer ce qui compte et à envisager une première amélioration. Elle devra proposer un état des lieux sans note, des conseils utiles et des ressources adaptées. Son radar représente des dimensions à discuter, pas une mesure de votre niveau.", link: { label: "Voir les écrans illustratifs du futur outil", href: "/experience" } },
      { question: "Puis-je utiliser la Boussole dès maintenant ?", answer: "Non. Aujourd’hui, seule la phase de préparation est ouverte : ce site compagnon informe, recueille des retours et prépare la co-conception. L’atelier et le cadrage sont prévus entre septembre et octobre 2026 ; un prototype à tester est visé fin 2026, puis une ouverture publique au début 2027.", link: { label: "Voir les étapes du projet", href: "/timeline" } },
      { question: "Comment puis-je participer sans devoir m’engager à tout ?", answer: "Vous pouvez simplement signaler votre intérêt, décrire une situation qui mérite d’être améliorée ou choisir de suivre les prochaines étapes. Vos retours alimenteront le questionnaire et l’atelier, où les artistes et partenaires décideront ensemble des priorités du prototype. Participer maintenant ne vous engage pas à tester la future version ni à participer à toutes les étapes." },
      { question: "Quels bénéfices concrets puis-je en attendre ?", answer: "La démarche vise à vous aider à identifier une première amélioration réaliste, à trouver des conseils plus proches de vos projets et à faire entendre votre expérience dans la construction de l’outil. Le bénéfice recherché est une relation plus praticable avec les outils et les collaborations, non une évaluation de vos compétences." },
    ],
    ...
    <section className="border-b border-slate-200 bg-slate-50 px-4 py-14 sm:py-16" aria-labelledby={`faq-${persona.id}-title`}>
      <div className="mx-auto max-w-5xl">
        <div className="max-w-3xl">
          ...
          <h2 id={`faq-${persona.id}-title`} className="mt-3 text-2xl font-extrabold tracking-tight text-slate-950 sm:text-3xl">Comprendre le pourquoi, la phase actuelle et la contribution possible</h2>
          <p className="mt-3 text-base leading-relaxed text-slate-600">Ces réponses précisent ce qui rend la démarche nécessaire, ce que la future Boussole doit encore définir, comment vous pouvez contribuer et ce que vous pouvez en attendre.</p>
        </div>
